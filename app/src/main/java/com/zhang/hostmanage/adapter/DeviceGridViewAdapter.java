...
/**
 * 作者：Administrator on 2016/9/22 17:07
 * 描述：
 */
public class  DeviceGridViewAdapter extends BaseAdapter
{
    ...
    public DeviceGridViewAdapter(Context context, List<String> mDatas)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            convertView = mInflater.inflate(R.layout.device_griditem, parent,
                    false);
